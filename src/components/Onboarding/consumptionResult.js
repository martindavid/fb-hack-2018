        ...
        return (
            <Box justify="center" pad={{vertical: 'none', horizontal: 'none', between: 'none'}}>
                <Box align="center" direction='column'>
                    ...
                    <Distribution series={[{"label": "Food", "value": food, "colorIndex": "graph-1"}, {"label": "Housing", "value": housing, "colorIndex": "accent-2"}, {"label": "Transport", "value": transport, "colorIndex": "unset"}, {"label": "Goods", "value": goods, "colorIndex": "graph-1"}, {"label": "Services", "value": services, "colorIndex": "graph-1"}]}
                                  full={false}
                                  size='small' />
                    <Label align="center">
                        Now, warrior!
